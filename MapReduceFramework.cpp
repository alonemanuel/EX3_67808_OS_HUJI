...
void emit3(K3 *key, V3 *value, void *context)
{
	...
	cout << LOG_PREFIX << "(Inside threadmapred) Output vec is now of size: " << curr_context->outputVec->size()
		 << endl;
...
//	cout << LOG_PREFIX << "(Inside threadmapred) Output vec is now of size: " << context->outputVec.size()<<endl;
}
...
//	cout << LOG_PREFIX << "(Inside startmapred) Output vec is now of size: " << outputVec.size()<<endl;
